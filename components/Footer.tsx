            ...
            <section className="SiteFooter__wrapper" id="footer">
              ...
              C35.3,13.3,35.3,13.3,35.3,13.3z"
                            ...
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.facebook.com/AZEEC.2020/"
                                    data-auto-id="true"
                        ...
                        <div className="text">
                            ...
                            <div className="column">
                                <span className="copyright myGray">
                                    All rights reserved © {(new Date().getFullYear())} AZEEC 
                                </span>
                            </div>
                        </div>
                    </div>
